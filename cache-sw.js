...
self.addEventListener('fetch',(e) => {
    if (e.request.url.startsWith('chrome-extension://')||e.request.url.includes('google-analytics.com')) {
        return;
    }
    e.respondWith(
        ...
        .then(cached => {
            ...
            .then(response => {
                ...
                if (e.request.url.includes('cdn.jsdelivr.net')||e.request.url.includes('unpkg.com')||e.request.method==='GET') {
